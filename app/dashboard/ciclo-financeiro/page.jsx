    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
          <div style={{ background: 'var(--fs-bg)', borderRadius: 10, padding: '16px', textAlign: 'center' }}>
            <div style={{ color: 'var(--fs-text-2)', fontSize: 12, marginBottom: 4 }}>CICLO OPERACIONAL</div>
            <div style={{ fontSize: 32, fontWeight: 900, color: '#f59e0b' }}>50 dias</div>
            <div style={{ color: 'var(--fs-text-4)', fontSize: 12 }}>PMR (28) + PME (22)</div>
          </div>
          <div style={{ background: 'var(--fs-bg)', borderRadius: 10, padding: '16px', textAlign: 'center' }}>
            <div style={{ color: 'var(--fs-text-2)', fontSize: 12, marginBottom: 4 }}>PRAZO DE PAGAMENTO</div>
            <div style={{ fontSize: 32, fontWeight: 900, color: '#3b82f6' }}>35 dias</div>
            <div style={{ color: 'var(--fs-text-4)', fontSize: 12 }}>5 dias acima do ideal</div>
          </div>
          <div style={{ background: 'var(--fs-bg)', borderRadius: 10, padding: '16px', textAlign: 'center' }}>
            <div style={{ color: 'var(--fs-text-2)', fontSize: 12, marginBottom: 4 }}>CICLO FINANCEIRO</div>
            <div style={{ fontSize: 32, fontWeight: 900, color: '#3b82f6' }}>15 dias</div>
            <div style={{ color: 'var(--fs-text-4)', fontSize: 12 }}>Ciclo Oper. (50) - PMP (35)</div>
          </div>
        </div>
      </div>
    </div>
