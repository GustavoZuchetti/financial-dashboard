...
export async function fetchContas(integ, recurso, pagina = 1, limite = 100, filtros = {}) {
  ...
  const url = `${BLING.API_BASE}/${recurso}?${params.toString()}`
...
export async function montarRegistrosFluxo(admin, integ, recurso, tipoFluxo, pagina, limite, categoriasMap, nomesContato, itensPre = null, filtros = {}) {
