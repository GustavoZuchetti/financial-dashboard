...
export const DRE_LINES = [
  { key:'receita_bruta',     label:'Receita Bruta',        tipos:['receita'],            sign:-1, isSubtotal:false, color:'#22c55e' },
  { key:'deducoes',          label:'(-) Deduções',         tipos:['deducao'],            sign:+1, isSubtotal:false, color:'#f97316' },
  { key:'receita_liquida',   label:'= Receita Líquida',    tipos:[],                     sign: 0, isSubtotal:true,  color:'#3b82f6' },
  { key:'custos_variaveis',  label:'(-) Custos Variáveis', tipos:['custo'],              sign:+1, isSubtotal:false, color:'#ef4444' },
  { key:'lucro_bruto',       label:'= Lucro Bruto',        tipos:[],                     sign: 0, isSubtotal:true,  color:'#3b82f6' },
  { key:'despesas_fixas',    label:'(-) Despesas Fixas',   tipos:['despesa'],            sign:+1, isSubtotal:false, color:'#f59e0b' },
  { key:'ebitda',            label:'= EBITDA',             tipos:[],                     sign: 0, isSubtotal:true,  color:'#14b8a6' },
  { key:'impostos_lucro',    label:'(-) Impostos s/ Lucro',tipos:['imposto_lucro'],      sign:+1, isSubtotal:false, color:'#f97316' },
  { key:'receitas_fin',      label:'(+) Rec. Financeiras', tipos:['receita_financeira'], sign:-1, isSubtotal:false, color:'#22c55e' },
  { key:'despesas_fin',      label:'(-) Desp. Financeiras',tipos:['despesa_financeira'], sign:+1, isSubtotal:false, color:'#ef4444' },
  { key:'resultado_liquido', label:'= Resultado Líquido',  tipos:[],                     sign: 0, isSubtotal:true,  color:'#8b5cf6' },
  { key:'investimentos',     label:'(-) Investimentos',    tipos:['investimento'],       sign:+1, isSubtotal:false, color:'#64748b' },
  { key:'resultado_final',   label:'= Resultado Final',    tipos:[],                     sign: 0, isSubtotal:true,  color:'#3b82f6' },
]
