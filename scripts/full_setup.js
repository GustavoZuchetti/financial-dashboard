...
async function runSetup() {
  try {
    ...
    const contas = [
      ...
      { codigo: '1.2', nome: 'IMPOSTOS SOBRE RECEITA', tipo: 'deducao', nivel: 0 },
      { codigo: '1.2.1', nome: 'COFINS', tipo: 'deducao', nivel: 1, pai: '1.2' },
      { codigo: '1.2.2', nome: 'ISS', tipo: 'deducao', nivel: 1, pai: '1.2' },
      { codigo: '1.2.3', nome: 'PIS', tipo: 'deducao', nivel: 1, pai: '1.2' },
